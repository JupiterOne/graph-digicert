...
interface StaticPaginationResource {
  page: PaginatedResponse;
}

export type ResourceKey = 'domains' | 'users' | 'orders';

export type IterateApiCallback<T> = (
  resources: T[],
) => boolean | void | Promise<boolean | void>;

export type CommonResponse<T extends ResourceKey, U> = {
  [K in T]: U;
} & StaticPaginationResource;
